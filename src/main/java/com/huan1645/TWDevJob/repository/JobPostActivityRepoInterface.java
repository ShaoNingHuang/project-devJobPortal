...
import com.huan1645.TWDevJob.entity.IRecruiterJobs;
...
public interface JobPostActivityRepoInterface extends JpaRepository<JobPostActivity, Integer> {
    ...
    List<JobPostActivity> search(@Param("job") String job, @Param("location") String location, @Param("remote") List<String> remote, @Param("type") List<String> type, @Param("date") LocalDate date);
}
